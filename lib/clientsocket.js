...
function AGClientSocket(socketOptions) {
    ...
    if (typeof this.options.query === 'string') {
        this.options.query = new URLParams(this.options.query);
    }
...
AGClientSocket.AUTHENTICATED = AGClientSocket.prototype.AUTHENTICATED =
    'authenticated';
AGClientSocket.UNAUTHENTICATED = AGClientSocket.prototype.UNAUTHENTICATED =
    'unauthenticated';
...
AGClientSocket.UNSUBSCRIBED = AGClientSocket.prototype.UNSUBSCRIBED =
...
AGClientSocket.prototype._privateRPCHandlerMap = {
    '#setAuthToken': function(data, request) {
        if (data) {
            ...
            request.error(
                new InvalidMessageError('No token data provided by #setAuthToken event')
            );
        }
    },
...
AGClientSocket.prototype._abortAllPendingEventsDueToBadConnection = function(
    failureType
) {
...
AGClientSocket.prototype.getReceiverConsumerBackpressure = function(
    consumerId
) {
...
AGClientSocket.prototype.getProcedureConsumerBackpressure = function(
    consumerId
) {
...
AGClientSocket.prototype.getChannelListenerConsumerStats = function(
    consumerId
) {
...
AGClientSocket.prototype.getChannelListenerConsumerBackpressure = function(
    consumerId
) {
    return this._channelEventDemux.getConsumerBackpressure(consumerId);
};

AGClientSocket.prototype.getChannelOutputConsumerBackpressure = function(
    consumerId
) {
...
AGClientSocket.prototype.channelCloseAllListeners = function(channelName) {
    let listenerStreams = this._getAllChannelStreamNames(channelName).forEach(
        (streamName) => {
...
AGClientSocket.prototype.channelGetOutputConsumerStatsList = function(
    channelName
) {
    return this._channelDataDemux.getConsumerStatsList(channelName);
};

AGClientSocket.prototype.channelGetListenerConsumerStatsList = function(
    channelName,
    eventName
) {
...
AGClientSocket.prototype.channelGetAllListenersConsumerStatsList = function(
    channelName
) {
...
AGClientSocket.prototype.channelGetAllListenersBackpressure = function(
    channelName
) {
